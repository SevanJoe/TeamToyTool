...
namespace TeamToyTool.Data
{
    class ExcelManager
    {
        private const string FILE_PATH = "E:\\5.xls";
        ...
        public ExcelManager(DataManager dataManager)
        {
            mApplication = new Application();
            object Nothing = Missing.Value;
            mWorkbook = mApplication.Workbooks.Open(FILE_PATH, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing);
        ...
        private void saveSheet(User user, int sheetIndex, int userIndex = 0)
        {
            ...
            List<ToDo> todoList = user.getValidatedToDoList(MONTH);
